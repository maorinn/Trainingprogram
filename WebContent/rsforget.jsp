...
<head>
	...
	<link rel="stylesheet" href="./assets/repage.css" />
...
<div class="row">
	<div class="col-lg-9 col-sm-12">
	     <div class="categories-title">
           ...
           <a href="#" style="color:#C9E0E0; text-decoration: none; font-size: 17px;">重置密码</a>
        </div>
        
        <div class="login">
		    <form onsubmit="return false;">
		    <div class="he01" style="background:#3497DA;color:white;margin:8px;width: 845px;height: 50px;padding-top: 15px;padding-left:20px;-moz-border-radius: 10px; -webkit-border-radius: 10px;border-radius:10px;margin-left:0px;">请输入您的<b>电子邮箱地址</b>，我们将会发送一份邮件协助您重置密码。</div><br>
            
                 <input type="text" class="form-control input-block input-lg" placeholder="  输入邮箱地址" id="email">
                 <input type="text" class="form-control input-block input-lg" placeholder="  用户名" id="email">
                 <input type="text" class="form-control input-block input-lg" placeholder="  新密码" id="email"><br>
                 <button class="btn btn-primary btn-block btn-lg" id="reset" type="submit">重置密码</button>
